...
export default {
    data() {
        return {
            columns: [
                ...
                // { title: 'Time Off', field: 'timeoff', sortable: true },
    ...
    computed: {
        ...mapGetters('TeachersIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('TeachersIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
